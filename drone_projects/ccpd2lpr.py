...
# CCPD车牌有重复，应该是不同角度或者模糊程度C:\Users\baiyuntian\Desktop\demo\YOLOv5-LPRNet-Licence-Recognition\datasets\ccpd\images\train
path = r'./train'  # 改成自己的车牌路径
# path = r'C:\Users\baiyuntian\Desktop\demo\YOLOv5-LPRNet-Licence-Recognition\test_video\1.mp4'  # 改成自己的车牌路径
...
for filename in os.listdir(path):
    ...
    cv2.imencode('.jpg', img)[1].tofile(r"./rec_images/{}.jpg".format(result))
    # 图片中文名会报错C:\Users\baiyuntian\Desktop\demo\YOLOv5-LPRNet-Licence-Recognition\datasets\ccpd\images\train
